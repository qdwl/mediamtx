...
// #cgo linux,amd64 LDFLAGS: -L${SRCDIR}/../../thirdparty/ffmpeg-n6.1.2-linux-amd64/lib -lavcodec -lavutil -lswscale -lswresample
// #cgo linux,amd64 CFLAGS: -I${SRCDIR}/../../thirdparty/ffmpeg-n6.1.2-linux-amd64/include
